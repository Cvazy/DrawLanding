...
export const WinnerStep: FC<IWinnerStep> = ({
  ...
  const containerSizes = {
    small: "sm:justify-end",
    medium: "sm:justify-center",
    large: "",
  };
  ...
  return (
    <div className={`w-full`}>
      <div
        className={`flex items-center ${containerSizes[size]} gap-5 w-full sm:gap-6 lg:gap-7 xl:gap-8 2xl:gap-10 3xl:gap-12`}
      >
        <Image
          width={100}
          height={100}
